...
import { Fiche, type FicheTileColumns } from './Fiche'
...
export function FicheModal({ row, schema, tile, i18n, canEdit, onRowUpdated, onClose }: FicheModalProps) {
  const t = useT()
    ...
    <div className="modal-backdrop" onClick={onClose}>
      ...
      >
        ...
        {editing
          ...
          : <Fiche row={row} schema={schema} tile={tile} i18n={i18n} />}
      </div>
    </div>,
    document.body,
  )
