...
// Une vue par mode (periodic_leaderboard_*, cf. migration) : meilleure ligne par joueur et par
// quiz, déjà jointe à periodic_profiles pour pseudo/avatar (vue security-definer, volontaire —
...
const VIEW_BY_MODE: Record<GameMode, string> = {
  classic: 'periodic_leaderboard_classic',
  timeAttack: 'periodic_leaderboard_time_attack',
  noMistake: 'periodic_leaderboard_no_mistake',
}
