...
// Projet Supabase partagé avec Oliver Quiz (même auth.users, tables préfixées `periodic_`
// dans ce projet) : un compte créé sur l'une des deux applis fonctionne sur l'autre.
